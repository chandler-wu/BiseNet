...
def parse_args():
    ...
    parse.add_argument('--config', dest='config', type=str,
            default='/mnt/d/code/seg/BiseNet/configs/jingke/edge_20230817_ub.py',)
...
def train():
    ...
    lr_schdr = WarmupPolyLrScheduler(optim, power=0.9,
        max_iter=cfg.epochs, warmup_iter=cfg.warmup_epochs,
    ...
    for epoch in range(cfg.epochs):
        ...
        if float(iou_content[-2][2]) > max_miou:
            save_pth = osp.join(cfg.respth, 'best.pth')
